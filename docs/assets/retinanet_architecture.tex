...
\usepackage{import}
\subimport{\detokenize{../plot_neural_net/layers/}}{init}
...
\node[canvas is zy plane at x=0] (input) at (-5,0,0) {\includegraphics[width=5cm,height=5cm]{\detokenize{cell_counting_result.png}}};
